  ...
  return (
    <>
      <StoriesLayout info={Info}>
        <p>博大精深的中華文化由眾多領域構成，包括哲學思想、文學藝術、歷史發展、社會結構、宗教信仰、科技成就、民俗風情、對外交流、當代傳承等。我們分別為中學和小學定製了內容豐富、主題多元的「中華文化常備書目」，為青少年讀者學習中華文化提供適切的內容。</p>

        <NGrid columnsCount={2}>

          <FileCard
            cover = "https://lh3.google.com/u/0/d/1o_zRUnQre0MAkqQcNUI_wm7bZbeLVr0u=w3600-h2010-iv1"
            title = "中華文化開館包（中學）"
        ...
        <p>對青少年身心健康、人文素養、公民意識、身份認同、國家情懷的培養，都與中華文化的傳承和創新密切相關。我們在深入了解中小學課程結構及教學需求的基礎上，推出中學組主題書單，涵蓋中文、公民與社會發展、資訊及通訊科技、健康管理與社會關懷、歷史、地理、倫理與宗教、國家安全教育等學科和領域。</p>
        ...
        <p>同步推出小學組主題書單，涵蓋中國語文、科學科、人文科、國家安全教育等學科和領域。</p>
        ...
        <p>「開館包」及「主題閱讀包」訂購方式靈活，可提供電子書、紙本書等產品，支持年租或買斷的服務模式。主題書單將會陸續更新，亦可根據用戶需要提供定製服務。</p>
