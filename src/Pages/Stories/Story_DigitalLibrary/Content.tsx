...
export default function Content() {
  return (
    <StoriesLayout info={Info}>
      <p>
        「知書閱聽圖書館」是一個定製化、一站式的電子閱讀平台，為機構提供一站式電子閱讀解決方案，目前已被香港公共圖書館、中小學、企業、協會等400
        多家機構所採用。平台搭載電子書、有聲書、課程、視頻等海量多媒體資源，具備在線閱讀、筆記、AI朗讀、閱讀報告自動生成等全新功能，配合豐富多元的閱讀推廣活動，兩文三語助力讀者在香港閱讀全球，成為「數碼時代終身閱讀者」。
      </p>
      ...
      <p>
        儒家文化中的「五常」（仁、義、禮、智、信），強調了個人品德和社會倫理的核心要素；而「六藝」（禮、樂、射、禦、書、數），則提供了培養君子和完善人格的具體學科及方法。我們以「五常」與「六藝」中的價值要素作為產品設計理念的文化根基，開設了中華文化專題電子圖書館，並逐漸形成了中華傳統文化閱讀教育框架。中華文化主題閱讀以塑造品德和修養為核心，強調社會和諧、人際關係和知行合一的理念，充分發揮其潛在的涵養作用，品味閱讀雅緻、彰顯閱讀價值、弘揚文化力量。
      </p>

      <FileCard
        cover="https://i.pinimg.com/originals/d1/7b/5a/d17b5a0336670f1404c184d332621b63.jpg"
        title="琴棋書畫"
      ...
      <FileCard
        cover="https://i.pinimg.com/originals/8d/58/e4/8d58e4e267f504b917534b1077705a32.jpg"
        title="古蜀文化之源｜三星堆"
      ...
      <FileCard
        cover="https://i.pinimg.com/originals/1e/62/41/1e6241508cf383c165f5d8c9ea5f775f.jpg"
        title="中國文化符號｜故宮"
      ...
      <FileCard
        cover="https://i.pinimg.com/originals/77/37/59/773759185358f6b725cc324c69382206.jpg"
        title="中國文化符號｜長城"
      ...
      <FileCard
        cover="https://i.pinimg.com/originals/03/f6/28/03f628a8fa96844be7984572b4b5f6ba.jpg"
        title="連同世界的路｜絲綢之路"
